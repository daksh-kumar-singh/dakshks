      ...
      <main className="mx-auto max-w-3xl px-4 py-12 prose dark:prose-invert">
        ...
        <ul>
          ...
          <li>
            ...
            <em> Nanophotonics</em>.
            <a href="https://doi.org/10.1515/nanoph-2025-0049" target="_blank" rel="noopener noreferrer"> https://doi.org/10.1515/nanoph-2025-0049</a>
          </li>
          <li>
            Wilson, B., Chen, Y., <strong>Singh, D. K.</strong>, Ojha, R., Bezick, M., Pott, J., Shalaev, V. M., Boltasseva, A., &amp; Kildishev, A. V. (2024).
            Machine-learning-assisted optical authentication of chip tampering. <em>Photonic Computing: From Materials and Devices to Systems and Applications</em>, 16.
            <a href="https://doi.org/10.1117/12.3027858" target="_blank" rel="noopener noreferrer"> https://doi.org/10.1117/12.3027858</a>
          </li>
          <li>
            Wilson, B., Chen, Y., <strong>Singh, D. K.</strong>, Ojha, R., Pottle, J., Bezick, M., Boltasseva, A., Shalaev, V. M., &amp; Kildishev, A. V. (2024).
            Authentication through residual attention-based processing of tampered optical responses. <em>Advanced Photonics</em>, 6(05).
            <a href="https://doi.org/10.1117/1.ap.6.5.056002" target="_blank" rel="noopener noreferrer"> https://doi.org/10.1117/1.ap.6.5.056002</a>
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Singh, D. K.</strong>, Ojha, R.; Co-Authors: Chen, Y., Wilson, B., Shalaev, V., Boltasseva, A., Kildishev, A. (2023).
            Machine Learning Assisted Realization of PUFs with Random Plasmonic Systems. <em>Cyberinfrastructure Symposium, RCAC</em>, West Lafayette, IN.
          </li>
          <li>
        ...
        <ul className="space-y-6">
          <li>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Contribute to ongoing research in <strong>nanofabrication</strong> and <strong>quantum photonics</strong>, focusing on the design, fabrication, and characterization of photonic devices.</li>
              ...
              <li>Co-author of multiple <strong>peer-reviewed publications</strong> and a <strong>patent (pending)</strong>.</li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Simulated <strong>nanostructured metasurfaces</strong> to enhance single-photon emission using 2D materials such as <strong>graphene</strong> and <strong>WSe2</strong>.</li>
              ...
              <li>Conducted <strong>optical characterization</strong> for emitter–cavity coupling, integrating fabrication with testing workflows.</li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <li>Attended the <strong>U.S. Quantum Information Science (USQIS) Summer School</strong> at <strong>Oak Ridge National Laboratory</strong>.</li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              <li>Selected as one of <strong>400</strong> students for Purdue’s competitive <strong>SURF</strong> program to conduct interdisciplinary research at <strong>Birck Nanotechnology Center</strong>.</li>
              ...
              <li>Helped establish a <strong>time-correlated single-photon counting (TCSPC)</strong> system and performed <strong>photoluminescence (PL)</strong> and <strong>g2</strong> correlation measurements to characterize quantum emitters.</li>
              <li>Integrated optical components, detectors, and software into a functional experimental platform.</li>
            </ul>
          </li>
          ...
          <li>
            ...
            <ul className="list-disc list-inside mt-2 space-y-1">
              ...
              <li>Developed early familiarity with <strong>machine learning models</strong> for quantitative analysis of optical/electrical data.</li>
            </ul>
          </li>
        </ul>
